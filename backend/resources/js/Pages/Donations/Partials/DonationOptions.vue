<template>
    <jet-form-section @submitted="createDonate">
                ...
                <div class="flex items-center mt-2">
                    ...
                    <div class="ml-4 leading-tigh">
                        ...
                        <div class="p-2">
                            ...
                            <div class="text-sm text-gray-700">
                                ...
                                <ul class="list-decimal pl-10">
                                    <li><font class="text-black text-lg">BSP Pay:</font> This option is only available to those who are existing BSP customers.</li>
                                    <li><font class="text-black text-lg">Visa / Mastercard:</font> This option is available to anyone who has a valid Visa or Mastercard.</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="p-2">
                            ...
                            <div class="text-sm text-gray-700">
                                Bank: Bank South Pacific <br>
                                Account Name: People's Movement for Change Party<br>
                                Account No.: ­­­­­­­­­­­­1007631227<br>
                                Branch: BSP Haus (BSB: 088-950)<br>
                                Swift code: BOSPPGPM<br>
        ...
        <template #form>
            ...
            <div class="col-span-6">
                <jet-label class="text-xl" value="Donation Options" />
                Choose a Payment Option to process your donation.
            </div>

            <div class="col-span-6">
                <jet-input type="radio" id="bsppay" value="bsppay" name="payment_option" @click="bsppay = true, paymentcard = false" />
                <jet-label for="bsppay" value="BSP Pay" class="inline-flex p-2" />
                <img class="object-cover rounded-2 inline-flex" width="180" height="180" :src="getBSPpayimg()">


                <jet-input type="radio" id="paymentcard" value="paymentcard" name="payment_option" @click="paymentcard = true, bsppay = false" />
                <jet-label for="paymentcard" value="Visa / Mastercard" class="inline-flex p-2" />
                <img class="object-cover rounded-2 inline-flex" width="180" height="180" :src="getPCimages()">
            </div>

            <div class="col-span-6 sm:col-span-4" v-if="bsppay">

                <jet-button :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    <img class="object-cover rounded-2" width="360" height="360" :src="getBSPpaybuttonimg()">
                </jet-button>

            </div>

            <div class="col-span-6 sm:col-span-4" v-if="paymentcard">
                ...
                <div class="flex items-center">
                    <img class="object-cover rounded-2" width="180" height="180" :src="getPCimages()">
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            getBSPpaybuttonimg() {
                return 'img/bsppayid.gif';
            },

            getBSPpayimg() {
                return 'img/BSPpay.png';
            }
        },
    })
</script>
